...
$rdm_row = mysqli_num_rows($rdm_query);
...
<body class="bg-light">
    ...
    <div class="container">
        <main>
            ...
            <h4 class="mb-3">Redeem Verify</h4>
            <div class="row g-5">
                <div class="col-md-5 col-lg-4 order-md-last">
                    <h4 class="d-flex justify-content-between align-items-center mb-3">
                        <span class="text-primary">Your cart</span>
                        <span class="badge bg-primary rounded-pill"><?php echo $rdm_row ?></span>
                    </h4>
                    <?php if ($rdm_row > 0) : ?>
                        <ul class="list-group mb-3">
                            <?php while ($rdm = mysqli_fetch_assoc($rdm_query)) : ?>
                                <li class="list-group-item d-flex justify-content-between lh-sm">
                                    <div>
                                        <h6 class="my-0"><?php echo $rdm['rd_redeemOrder']; ?> - <?php echo $rdm['rd_option']; ?></h6>
                                    </div>
                                </li>
                            <?php endwhile; ?>
                        </ul>
                ...
                <div class="col-md-7 col-lg-8">
                    <form action="../condb/checkout-redeem.php" class="needs-validation" novalidate method="post">
                        <div class="row g-3">
                            <div class="col-sm-6">
                                <label for="firstName" class="form-label">Username</label>
                                <input type="text" class="form-control" name="username" placeholder="" value="<?php echo $username ?>" required>
                                <input type="hidden" name="row" value="<?php echo $rdm_row ?>">
                                <input type="hidden" name="name" value="<?php echo $rdm['rd_redeemOrder']; ?>" >
                            </div>
                        </div>
                        <hr class="my-4">
