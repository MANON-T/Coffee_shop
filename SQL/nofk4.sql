...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 17, 2024 at 08:01 AM
...
(1, 'Chocolate Cake', 16, 100, 'des_1.jpg'),
...
INSERT INTO `order_detail` (`ord_detailID`, `ord_productID`, `ord_orderID`, `ord_productName`, `ord_option`, `ord_quantity`, `ord_price`, `ord_totalPrice`, `ord_status`) VALUES
...
--
ALTER TABLE `order_detail`
  MODIFY `ord_detailID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;

--
-- AUTO_INCREMENT for table `order_main`
--
ALTER TABLE `order_main`
  MODIFY `ord_orderID` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
